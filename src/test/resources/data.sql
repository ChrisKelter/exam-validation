INSERT INTO APP_user (ID, USERNAME, PASSWORD, AUTHORITIES, FIRST_NAME, LAST_NAME, EMAIL) VALUES ('test-01', 'admin', '$2a$10$DAG/wOAS0MU/egnCqlG4YOITO7ZIuGqUrsrFCrE7xPJxACwWQKl3.', 'user::admin', 'Admin', 'ISTRATOR', 'admin@oeh.at');
INSERT INTO APP_user (ID, USERNAME, PASSWORD, AUTHORITIES, FIRST_NAME, LAST_NAME, EMAIL) VALUES ('test-02', 'user', '$2a$10$DAG/wOAS0MU/egnCqlG4YOITO7ZIuGqUrsrFCrE7xPJxACwWQKl3.', 'user', 'user', 'The 1', 'user@oeh.at');
INSERT INTO APP_user (ID, USERNAME, PASSWORD, AUTHORITIES, FIRST_NAME, LAST_NAME, EMAIL) VALUES ('test-03', 'validation', '$2a$10$DAG/wOAS0MU/egnCqlG4YOITO7ZIuGqUrsrFCrE7xPJxACwWQKl3.', 'validation', 'validation', 'The 2', 'validation@oeh.at');
